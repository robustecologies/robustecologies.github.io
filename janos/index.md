...
[![Version](https://img.shields.io/badge/version-1.9.0-blue.svg)](https://github.com/robustecologies/janos)
[![R
...
| Exported S3 classes (all with `print`, `summary`, `plot`) | 28 | 28 |

All 65 user-facing functions are formula-based: the C++ back-end is
