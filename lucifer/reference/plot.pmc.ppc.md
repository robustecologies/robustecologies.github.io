# Plots of posterior predictive checks for pmc

This may be used to plot, or save plots of, samples in an object of
class `pmc.ppc`. A variety of plots is provided.
...
- Rows:
  ...
  records associated by row in the object of class `pmc.ppc`. Only these
