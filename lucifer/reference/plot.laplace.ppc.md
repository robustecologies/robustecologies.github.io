# Plots of posterior predictive checks for laplace

This may be used to plot, or save plots of, samples in an object of
class `laplace.ppc`. A variety of plots is provided.
...
- x:
  ...
  This required argument is an object of class `laplace.ppc`.
...
- Rows:
  ...
  records associated by row in the object of class `laplace.ppc`. Only
