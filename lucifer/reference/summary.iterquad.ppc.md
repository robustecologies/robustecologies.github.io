# Posterior predictive check summary for iterative quadrature
...
- object:
  ...
  An object of class `iterquad.ppc` is required.
...
This function summarizes an object of class `iterquad.ppc`, which
