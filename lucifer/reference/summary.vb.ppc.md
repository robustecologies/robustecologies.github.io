# Posterior predictive check summary for Variational Bayes
...
- object:
  ...
  An object of class `vb.ppc` is required.
...
This function summarizes an object of class `vb.ppc`, which consists of
posterior predictive checks on either \\\textbf{y}^{new}\\ or
\\\textbf{y}^{rep}\\, depending respectively on whether unobserved
