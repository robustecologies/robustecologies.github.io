...
Calculates the basin entropy, a measure of unpredictability in the final
state of a dynamical system based on the structure of basins of
attraction. Basin entropy quantifies the uncertainty when initial
conditions are known only within a finite box.
