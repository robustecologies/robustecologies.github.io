...
to the polynomial \\z^n - 1 = 0\\ using a parallel Rcpp/OpenMP
implementation.
...
- n_cores:
  ...
  Integer. Number of CPU cores to use for parallel computation. If
  `NULL` (default), uses all available cores minus one.
...
McMullen, C. T. (1987). Families of rational maps and iterative
root-finding algorithms. *Annals of Mathematics*, 125(3), 467-493.
[doi:10.2307/1971408](https://doi.org/10.2307/1971408)
