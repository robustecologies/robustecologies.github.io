...
# ===================================================================== #
# Using palettes() for colorblind-safe colors                           #
# ===================================================================== #
# Okabe-Ito palette (colorblind-safe)
plot(basins, colors = palettes(palette = "okabe_ito")[1:3])

# Alhambra-inspired palette
plot(basins, colors = palettes(palette = "alhambra_nazari")[1:3])
