...
eigenvalue problems. In P. H. Rabinowitz (ed.), *Applications of
Bifurcation Theory* (pp. 359-384). Academic Press.

Allgower, E. L., & Georg, K. (2003). *Introduction to Numerical
Continuation Methods*. SIAM Classics in Applied Mathematics 45.
[doi:10.1137/1.9780898719154](https://doi.org/10.1137/1.9780898719154)
