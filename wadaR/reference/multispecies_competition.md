...
Creates a Huisman-Weissing resource competition system whose basin
boundaries can exhibit fractal structure and Wada-like unpredictability
in species outcomes.
...
- scenario:
  ...
  Character. Competition scenario: `"5species"` specifies 5 species
  competing for 3 resources, producing 2 possible outcomes (binary basin
  structure); `"8species"` specifies 8 species with invasion, producing
  3+ possible outcomes suitable for Wada detection.
...
where \\N_i\\ is the abundance of species \\i\\, \\R_j\\ is the
concentration of resource \\j\\, \\\mu_i\\ is the specific growth rate
of species \\i\\, \\m_i\\ is the mortality rate of species \\i\\, \\D\\
is the dilution rate, \\S_j\\ is the supply concentration of resource
\\j\\, \\K\_{ji}\\ is the half-saturation constant of species \\i\\ for
resource \\j\\, \\c\_{ji}\\ is the resource content (consumption
coefficient), and \\r_i\\ is the maximum growth rate.
...
either species {1, 2, 3} survive (Outcome 1) or species {1, 4, 5}
survive (Outcome 2). The basin boundary between these outcomes is
fractal.
...
dominates: species 6 (Outcome 1), species 7 (Outcome 2), or species 8
(Outcome 3). With 3+ outcomes, the system can exhibit Wada basin
boundaries.
